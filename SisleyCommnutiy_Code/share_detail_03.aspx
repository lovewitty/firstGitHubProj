<%@ Page Language="C#" AutoEventWireup="true" CodeFile="share_detail_03.aspx.cs" Inherits="share_detail_03" %>

<%@ Register Src="Ascx/header.ascx" TagName="header" TagPrefix="uc1" %>
<%@ Register Src="Ascx/footer.ascx" TagName="footer" TagPrefix="uc2" %>
<%@ Register src="Ascx/Y_ArticleReply.ascx" tagname="Y_ArticleReply" tagprefix="uc3" %>

  

<%@ Register src="Ascx/productTry3List.ascx" tagname="productTry3List" tagprefix="uc4" %>


<%@ Register src="Ascx/CalnDaren.ascx" tagname="CalnDaren" tagprefix="uc5" %>
...
<div class="wrap">
    ...
    <div class="content" style="padding-top:7px;">
        <div class="crumbs">
   	当前位置：<a href="index.aspx">首页</a> <img src="images/arrow_01.gif" align="absmiddle" alt="" /> <a href="KOL-share.aspx">达人分享</a> <img src="images/arrow_01.gif" align="absmiddle" alt="" /> 详细内容</div>
  		<div class="KOLshare">
   	    <div class="KOLshare_l">
        	<div class="box_c">
            	...
            	<div class="calendar">
                    ...
                    <uc5:CalnDaren ID="CalnDaren1" runat="server" />
                    ...
                    <div class="btn_publ">
                        ...
                        <a href="Daren-express-3.aspx" onclick="return doSendShare()">
                            <img src="images/btn_publish.jpg" alt="发表分享" /></a></div>
        	<div class="box_c">
           	  <div class="title_pic"><img src="images/title_protest.jpg" alt="产品测评" /></div>
           	  <div class="protest" style="font-size:12px">
                <!-- Begin -->
                    
                 <!-- End -->
                  <uc4:productTry3List ID="productTry3List1" runat="server" />
                </div>
        	...
        	<div class="KOLshare_r">
        	  	<div class="cosmplan">
                    ...
                    <div class="cosmplan_title">
                        <asp:Literal ID="articleTitle" runat="server">全能乳液使用心得</asp:Literal></div>
                   <div class="share_content3">
                    	<div class="share_content_l"><img src="images/pic_133_133.jpg"  runat="server" id="productImg1" width="133" height="133" alt="" /></div>
                   	  <div class="share_content_r">
                       	<div class="share_content_name">
                               <asp:Literal ID="productTitle" runat="server">全能乳液 <span>asdfghjkl</span></asp:Literal></div>
                  <div class="share_content_intro">
                     <asp:Literal ID="productDescript" runat="server">
                            介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍
                            </asp:Literal>
                            </div>
                            <div class="share_content_grade">
                                    <asp:Literal ID="pingFenTotal" runat="server">
                            总评分： <em><span>4.0</span> / 5分</em> &nbsp;&nbsp;&nbsp;&nbsp;<img src="images/icon_star_1.gif" /> <img src="images/icon_star_1.gif" /> <img src="images/icon_star_1.gif" /> <img src="images/icon_star_1.gif" /> <img src="images/icon_star_2.gif" /> 
                            </asp:Literal>
                            </div>
                     		<div class="share_content_tabs2">
                            	<ul>
                                    <asp:Literal ID="pingFen" runat="server">
                                	<li><label>保湿度</label> 
                                	  <img src="images/icon_star_3.gif" align="absmiddle" /> <img src="images/icon_star_3.gif" align="absmiddle" /> <img src="images/icon_star_3.gif" align="absmiddle" /> <img src="images/icon_star_3.gif" align="absmiddle" /> <img src="images/icon_star_4.gif" align="absmiddle" /> <span>4分/5分</span></li>
                                	<li><label>性价比</label> 
                                	<img src="images/icon_star_3.gif" align="absmiddle" /> <img src="images/icon_star_3.gif" align="absmiddle" /> <img src="images/icon_star_3.gif" align="absmiddle" /> <img src="images/icon_star_3.gif" align="absmiddle" /> <img src="images/icon_star_4.gif" align="absmiddle" /> <span>4分/5分</span></li>
                                	<li><label>美白度</label> 
                                	<img src="images/icon_star_3.gif" align="absmiddle" /> <img src="images/icon_star_3.gif" align="absmiddle" /> <img src="images/icon_star_3.gif" align="absmiddle" /> <img src="images/icon_star_3.gif" align="absmiddle" /> <img src="images/icon_star_4.gif" align="absmiddle" /> <span>4分/5分</span></li>
                        ...
                        <!--<div class="share_content_tabs"><em>滋润度</em> <em>保湿度</em> <em>低刺激</em></div>-->
                      </div>
                        <div class="clr"></div>
                    </div>
              ...
              <div class="share_ctrl">
               ...
               <uc3:Y_ArticleReply ID="Y_ArticleReply1" runat="server" />
            </div>
