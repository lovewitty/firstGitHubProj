<%@ Page Language="C#" AutoEventWireup="true" CodeFile="e-magazine.aspx.cs" Inherits="e_magazine" %>
...
<div class="wrap">
    ...
    <div class="content" > 电子杂志
    <%--
    	<div class="crumbs">当前位置：<a href="index.aspx">首页</a> &gt; 杂志</div>
        <div class="titExch titPersonal"><h2>信息</h2></div>
        <div class="mainExch infoPad" >
            <div class="persTit markTit">
            	<ul>
                	<li class="first"><a href="personalInfo.aspx">基本信息</a></li>
                </ul>
            </div>
			<div class="markList clear">
            	<div class="Sl">
                	<div class="picWrap">
                    	<div class="pic">
                        	<a href="#" target="_blank"><img src="images/spic.jpg" alt="" /></a>
                        </div>
                    </div>
                    <div class="txt">
                        <p>会员级别: VIP会员</p>
                ...
                <div class="Sr">
                	<div class="subTit commTit"><a href="#">站内信<em>(5)</em></a><span>普通会员</span></div>
                    <div class="details">
                        <div class="columnTit">
                            <ul>
                                <li><a href="#" class="curr">我阅读过的文章</a></li>
                                <li class="lines">|</li>
                                <li><a href="#">我参与过的活动</a></li>
                                <li class="lines">|</li>
                                <li><a href="#">我的分享</a></li>
                                <li class="lines">|</li>
                                <li><a href="#">我的问题</a></li>
                        ...
                        <div class="timeTit">
                            <ul>
                                <li><a href="#" class="curr">全部(30天内)</a></li>
                                <li><a href="#">今日访问</a></li>
                                <li><a href="#">一天前</a></li>
                                <li><a href="#">两天前</a></li>
                                <li><a href="#">三天前</a></li>
                        ...
                        <div class="deta clear">
                        	<div class="imgWrap">
                            	<div class="img"><a href="#" target="_blank"><img src="images/img.jpg" alt="" /></a></div>
                            </div>
                            <div class="cont">
                            	<div class="txt">
                                	<div class="conTit"><a href="#" target="_blank">法式礼仪的禁忌</a></div>
                                    <p>法国是一个讲文明礼貌的国家。对妇女谦恭礼貌是法国人引以自豪的传统。...法国是一个讲文明礼貌的国家。对妇女谦恭礼貌是法国人引以自豪的传统。...</p>
                                    <p><a href="#" target="_blank">查看更多</a></p>
                                </div>
                            </div>
                        </div>
