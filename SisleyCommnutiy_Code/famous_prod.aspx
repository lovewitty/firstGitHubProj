<%@ Page Language="C#" AutoEventWireup="true" CodeFile="famous_prod.aspx.cs" Inherits="famous_prod" %>
...
<div class="wrap">
    ...
    <div class="content">
        ...
        <div class="famousProd">
        	<div class="prod" style="background:url('images/famous_prod.jpg') no-repeat;border:1px solid #DFDFDF;">
            	<div class="info">
                	<div class="tab">
                    	<ul>
                    ...
                    <div class="deta">
                        <div class="txt">
                            <p>1、粹炼珍稀黑玫瑰精华，协同丰富的滋养微量元素、维他命、植物精粹活性抗老成份，加乘作用，令肌肤沉溺于奢华乳霜的丰润呵护中。</p>
                            <p>只需15分钟，即刻改善岁月痕迹和疲惫倦容，回复肌肤紧实弹性<br />·饱满紧致宛若重生<br />·晶莹透亮活力焕采<br />·盈润弹性平滑匀嫩</p>
                            <p>丰润易推抹的玫瑰乳霜香氛质地，营造绵密细致的感官愉悦感受，舒缓心与肌的疲惫，密集滋养美肌改善倦容、抚褪岁月痕迹，肌肤重获活力、肤色充满光泽。</p>
                        </div>
                        <div class="txt">
                            <p>2、粹炼珍稀黑玫瑰精华，协同丰富的滋养微量元素、维他命、植物精粹活性抗老成份，加乘作用，令肌肤沉溺于奢华乳霜的丰润呵护中。</p>
                            <p>只需15分钟，即刻改善岁月痕迹和疲惫倦容，回复肌肤紧实弹性<br />·饱满紧致宛若重生<br />·晶莹透亮活力焕采<br />·盈润弹性平滑匀嫩</p>
                            <p>丰润易推抹的玫瑰乳霜香氛质地，营造绵密细致的感官愉悦感受，舒缓心与肌的疲惫，密集滋养美肌改善倦容、抚褪岁月痕迹，肌肤重获活力、肤色充满光泽。</p>
                        </div>
                        <div class="txt">
                            <p>3、粹炼珍稀黑玫瑰精华，协同丰富的滋养微量元素、维他命、植物精粹活性抗老成份，加乘作用，令肌肤沉溺于奢华乳霜的丰润呵护中。</p>
                            <p>只需15分钟，即刻改善岁月痕迹和疲惫倦容，回复肌肤紧实弹性<br />·饱满紧致宛若重生<br />·晶莹透亮活力焕采<br />·盈润弹性平滑匀嫩</p>
                            <p>丰润易推抹的玫瑰乳霜香氛质地，营造绵密细致的感官愉悦感受，舒缓心与肌的疲惫，密集滋养美肌改善倦容、抚褪岁月痕迹，肌肤重获活力、肤色充满光泽。</p>
                        </div>
                    </div>
