<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeFile="Daren-express-4.aspx.cs" Inherits="Daren_express_4" %>
                    ...
                    <div class="details">
                        <div class="condition">
                            <dl class="clear">
                                <dt>分类</dt>
                                <dd>
                                        <a href="Daren-express-1.aspx">达人测评</a>
                                         <a href="Daren-express-2.aspx">  生活趣闻</a>
                                          <a href="Daren-express-3.aspx">试用报告</a> 
                                          <a href="Daren-express-4.aspx" class="curr">活动分享</a> 
                                    </dd>
                            </dl>
                            <dl class="clear">
                                <dt>活动</dt>
                                <dd>
                                    <ul class="clear">
                                        <asp:Literal ID="ltlActivityList" runat="server">
                                        <li><a href="#" class="curr">玫瑰玫瑰我爱你</a></li>
                                        <li><a href="#">社区上线送祝福</a></li>
                                        <li><a href="#">玫瑰玫瑰我爱你</a></li>
                                        <li><a href="#">社区上线送祝福</a></li>
                                        <li><a href="#">玫瑰玫瑰我爱你</a></li>
                                        <li><a href="#">社区上线送祝福</a></li>
                                        <li><a href="#">玫瑰玫瑰我爱你</a></li>
                        ...
                        <div class="editExpress">
                            <dl class="clear">
                                <dt>标题：</dt>
                                <dd><asp:TextBox ID="txtSubject" runat="server"  class="subject"></asp:TextBox></dd>
                            </dl>
                            <dl class="clear">
                                <dt>内容：</dt>
                                <dd>
                        ...
                        <div class="btnExpr clear">
                                <asp:Button ID="btnSubmit" runat="server" Text="" class="btnExpress" onclick="btnSubmit_Click" 
                                  />
                                <input name="cancel" type="button" value="取消" class="btnCancel" />
                        </div>
                    </div>
                </div>
            </div>
