<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fexchange_success.aspx.cs" Inherits="fexchange_success" %>
    ...
    <div class="content">
        ...
        <div class="mainExch">
            ...
            <div class="successExch">
                ...
                <div class="txt n3">
                	<h3>兑礼柜台信息</h3>
                    <p>柜台所在处：<asp:Label ID="lblCounterName" runat="server" Text="Label"></asp:Label></p>
                    <p>柜台地址：<asp:Label ID="lblAddr" runat="server" Text="Label"></asp:Label></p>
                    <p>联系电话：<asp:Label ID="lblCounterPhone" runat="server" Text="Label"></asp:Label></p>
                </div>
            </div>
            <div class="cartList">
            	<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                    ...
                    <div class="details">                    
                        ...
                        <ul class="clear">
                            ...
                            <li>
                                <div class="n2">
                                    <a href="#" target="_blank"><%# DataBinder.Eval(Container.DataItem, "PerGiftData.GiftName")%> 
                                    <%#Eval("PerGiftData.GiftSKU")%></a></div>
                            </li>
                            <li>
                                <div class="n3">
                                    <%--<img class="opimgm" 
