<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserArticle_ProductType_Manage.aspx.cs" Inherits="AdminManage_UserArticle_ProductType_Manage" %>
    ...
    <TD align=left>
        ...
        <ItemTemplate>
         <tr id="trIdrep" runat="server" onMouseOver="this.bgColor='#C4DFF7'" onMouseOut="this.bgColor='#ffffff'">
                ...
                <td nowrap><%#Eval("Rules")%></td>               
                <td nowrap><%#Eval("Platform")%></td>
                <td nowrap><%#Eval("Prizes")%></td>
