...
public partial class AdminManage_weiboHomeManage : System.Web.UI.Page
{
    ...
    {
        DataSet ds = DBEntity.Tab_HomeWeibo.GetDs_Where(beginDate, endDate, keywords);
    ...
    protected void DataList1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Response.Redirect(string.Format("weiboHomeEdit.aspx?Idx={0}", btnEdit.CommandArgument.ToString()));
        }
