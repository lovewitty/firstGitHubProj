<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseMainManage.aspx.cs" Inherits="AdminManage_CourseMainManage" %>
...
<body>
  ...
  <TR height=28>
    <TD background=images/title_bg1.jpg>当前位置:查看课件</TD></TR>
  <TR>
    ...
    <TD align=left>
        ...
        <ItemTemplate>
         <tr id="trIdrep" runat="server" onMouseOver="this.bgColor='#C4DFF7'" onMouseOut="this.bgColor='#ffffff'">
                ...
                <td nowrap><img src="../upload/CourseMain/<%#Eval("PreviewImg")%>" width="50px" height="30px" /></td>
                <td nowrap><%#Cmn.Str.GetStr(Eval("CourseContent").ToString(),80,true)%></td>               
                  <td nowrap><%#Eval("SortNo")%></td>
                  <td nowrap><%#Eval("HomeShowBool")%></td>
                <td nowrap><%#Eval("DateCreated")%></td>
                <td nowrap><%#Eval("ReleaseDate")%></td>
                   <td nowrap>
