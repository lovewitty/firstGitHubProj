<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseTestTopic_DetailManage.aspx.cs" Inherits="AdminManage_CourseTestTopic_DetailManage" %>
...
<body>
  ...
  <TR height=28>
    <TD background=images/title_bg1.jpg>当前位置:查看课件测试题目</TD></TR>
  <TR>
    ...
    <TD align=left>
        ...
        <ItemTemplate>
         <tr id="trIdrep" runat="server" onMouseOver="this.bgColor='#C4DFF7'" onMouseOut="this.bgColor='#ffffff'">
                    ...
                    <td nowrap><%#Eval("QuestionText")%></td>   
                    <td nowrap><%#Eval("Aquestion")%></td>   			
                    <td nowrap><%#Eval("Bquestion")%></td>
                    <td nowrap><%#Eval("Cquestion")%></td>               
                    <td nowrap><%#Eval("Dquestion")%></td>
                    <td nowrap><%#Eval("Answer")%></td>
                    <td nowrap><%#Eval("CourseMainTitle")%></td>
                    <td nowrap><%#Eval("CourseMainType")%></td>
