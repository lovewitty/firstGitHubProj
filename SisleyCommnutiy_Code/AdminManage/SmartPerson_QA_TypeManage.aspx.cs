...
public partial class AdminManage_SmartPerson_QA_TypeManage : System.Web.UI.Page
{
 ...
 public string recordCount = "";
    ...
    {
        System.Data.DataSet ds = DBEntity.Tab_Smart_QA_Type.GetDs_Where(beginDate, endDate, keywords);
    ...
    protected void DataList1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Response.Redirect(string.Format("SmartPerson_QA_TypeEdit.aspx?Idx={0}", btnEdit.CommandArgument.ToString()));
        }

        if (e.CommandName == "deleteDeal")
        {
            new DBEntity.Tab_Smart_QA_Type().Delete(btnDelete.CommandArgument.ToString());
        }
