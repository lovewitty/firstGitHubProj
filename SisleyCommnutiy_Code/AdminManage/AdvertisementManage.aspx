<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdvertisementManage.aspx.cs" Inherits="AdminManage_AdvertisementManage" %>
...
<body>
  ...
  <TR height=28>
    <TD background=images/title_bg1.jpg>当前位置:查看广告位</TD></TR>
  <TR>
        ...
        <ItemTemplate>
         <tr id="trIdrep" runat="server" onMouseOver="this.bgColor='#C4DFF7'" onMouseOut="this.bgColor='#ffffff'">
                <td nowrap><%#Container.ItemIndex+1%> </td>   
                 <td nowrap><%#Eval("AdPostion")%></td>              			 					
           <td nowrap><%#Cmn.Str.GetStr(Eval("AdDescription").ToString(),50,true)%></td>
                <td nowrap><img src="../upload/Advertisement/<%#Eval("AdImg")%>" width="50px" height="30px" /></td>
                <td nowrap><a href='<%#Eval("Links")%>' target="_blank"><%#Eval("Links")%></a></td>
               
                   <td nowrap><%#Eval("OrderNumb")%></td>
