<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SmartPerson_QA_TypeManage.aspx.cs" Inherits="AdminManage_SmartPerson_QA_TypeManage" %>
...
<body>
  ...
  <TR height=28>
    <TD background=images/title_bg1.jpg>当前位置:查看贴身达人 Q&amp;A 类别</TD></TR>
  <TR>
...
<TABLE cellSpacing=0 cellPadding=2 width="95%" align=center border=0>
  <TR>
    <TD align=left>
        ...
        <FooterTemplate>
       <tr class="bgc_sum" >
                <td colspan="3">共<%=recordCount%>记录</td>                
              </tr>       
          </table></td>
        </tr>
      </table>
