<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseMainTypeManage.aspx.cs" Inherits="AdminManage_CourseMainTypeManage" %>
...
<body>
  ...
  <TR height=28>
    <TD background=images/title_bg1.jpg>当前位置:查看课件大类别</TD></TR>
  <TR>
...
<TABLE cellSpacing=0 cellPadding=2 width="95%" align=center border=0>
  <TR>
    <TD align=left>
        ...
        <FooterTemplate>
       <tr class="bgc_sum" >
                <td colspan="9">共<%=recordCount%>记录</td>                
              </tr>       
          </table></td>
        </tr>
      </table>
