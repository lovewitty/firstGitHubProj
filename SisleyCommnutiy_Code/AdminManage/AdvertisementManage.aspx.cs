...
public partial class AdminManage_AdvertisementManage : System.Web.UI.Page
{
    ...
    {
        DataSet ds = DBEntity.Tab_Advertisement.GetDs_Where(beginDate, endDate, keywords);
    ...
    protected void DataList1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Response.Redirect(string.Format("AdvertisementEdit.aspx?idx={0}", btnEdit.CommandArgument.ToString()));
        }
