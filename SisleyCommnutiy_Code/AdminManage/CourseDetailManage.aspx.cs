...
public partial class AdminManage_CourseDetailManage : System.Web.UI.Page
{
 ...
 public string recordCount = "";
    ...
    {
        System.Data.DataSet ds = DBEntity.Tab_CourseDetail.GetDs_Where(beginDate, endDate, keywords);
    ...
    protected void DataList1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Response.Redirect(string.Format("CourseDetailAddNew.aspx?Idx={0}", btnEdit.CommandArgument.ToString()));
        }

        if (e.CommandName == "deleteDeal")
        {
            new DBEntity.Tab_CourseDetail().Delete(btnDelete.CommandArgument.ToString());
        }
