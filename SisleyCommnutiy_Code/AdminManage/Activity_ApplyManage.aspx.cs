...
public partial class AdminManage_Activity_ApplyManage : System.Web.UI.Page
{
 ...
 public string recordCount = "";
    ...
    {
        System.Data.DataSet ds = DBEntity.Tab_Activity_Apply.GetDs_Where(beginDate, endDate, keywords);
    ...
    protected void DataList1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            new DBEntity.Tab_Activity_Apply().Delete(btnDelete.CommandArgument.ToString());
        }
