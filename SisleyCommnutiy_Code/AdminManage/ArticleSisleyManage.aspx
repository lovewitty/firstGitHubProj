<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArticleSisleyManage.aspx.cs" Inherits="AdminManage_ArticleSisleyManage" %>
...
<body>
  ...
  <TR height=28>
    <TD background=images/title_bg1.jpg>当前位置:查看希思黎的文章记录</TD></TR>
  <TR>
    ...
    <TD align=left>
        ...
        <ItemTemplate>
         <tr id="trIdrep" runat="server" onMouseOver="this.bgColor='#C4DFF7'" onMouseOut="this.bgColor='#ffffff'">
                        ...
                        <td nowrap><img src='../upload/Article/<%#Eval("PreviewPicture")%>' width="50px" height="30px" /></td>
          
                        <td nowrap><%#Eval("ReleaseDate")%></td>
                        <td nowrap><%#Eval("HomeShowsBool")%></td>
        ...
        <FooterTemplate>
       <tr class="bgc_sum" >
                <td colspan="7">共<%=recordCount%>记录</td>                
              </tr>       
          </table></td>
        </tr>
      </table>
