...
public partial class AdminManage_SmartPerson_QA_Manage : System.Web.UI.Page
{
 ...
 public string recordCount = "";
    ...
    {
        System.Data.DataSet ds = DBEntity.Tab_SmartPerson_QA.GetDs_Where(beginDate, endDate, keywords);
    ...
    protected void DataList1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Response.Redirect(string.Format("SmartPerson_QA_Edit.aspx?Idx={0}", btnEdit.CommandArgument.ToString()));
        }

        if (e.CommandName == "deleteDeal")
        {
            new DBEntity.Tab_SmartPerson_QA().Delete(btnDelete.CommandArgument.ToString());
        }
