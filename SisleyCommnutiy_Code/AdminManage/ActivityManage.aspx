<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActivityManage.aspx.cs" Inherits="AdminManage_ActivityManage" %>
       ...
       <HeaderTemplate>
        ...
        <ItemTemplate>
         <tr id="trIdrep" runat="server" onMouseOver="this.bgColor='#C4DFF7'" onMouseOut="this.bgColor='#ffffff'">
                ...
                <td nowrap><%#Cmn.Str.GetStr(Eval("ActiveTitle").ToString(), 30, true)%></td>              			 					
                <td nowrap><img src="../upload/Activity/<%#Eval("PreviewImg")%>" width="60px" height="40px" /></td>
                <td nowrap><%#Cmn.Str.GetStr(Eval("Rules").ToString(), 50, true)%></td>               
            
                 <td nowrap><%#Cmn.Str.GetStr(Eval("ActivityStartDate").ToString(),10,false)%></td>
                <td nowrap><%#Cmn.Str.GetStr(Eval("ActivityEndDate").ToString(), 10, false)%></td>
                     <td nowrap><img src="../upload/Activity/<%#Eval("DisplayHomePreview")%>" width="50px" height="30px" /></td>
                 <td nowrap><%#Eval("DisplayHomeBool")%></td>
                <td nowrap><%#Cmn.Str.GetStr(Eval("DateCreated").ToString(), 10, false)%> </td>
                <td nowrap>
        ...
        <FooterTemplate>
       <tr class="bgc_sum" >
                <td colspan="10">共<%=recordCount%>记录</td>                
              </tr>       
          </table></td>
        </tr>
      </table>
