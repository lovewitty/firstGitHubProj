<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductEdit.aspx.cs" Inherits="AdminManage_ProductEdit" %>
     ...
     <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
        ...
        <table cellspacing="0" cellpadding="2" width="95%" align="center" border="0" 
          ...
          <tr>
                ...
                <td style="color: #880000">  <div>
                    <asp:FileUpload ID="fileProImg" runat="server" />
                &nbsp;<asp:Image ID="ImgPath1" runat="server" Width=50px Height=30px />
               </div>                 </td>
            </tr>
            <tr>
