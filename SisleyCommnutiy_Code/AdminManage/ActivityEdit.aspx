<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeFile="ActivityEdit.aspx.cs" Inherits="AdminManage_ActivityEdit" %>
        ...
        <table cellspacing="0" cellpadding="2" width="95%" align="center" border="0" 
            ...
            <tr >
                ...
                <td style="color: #880000">
                    ...
                    * 上传请使用英文名称<br />
                    <asp:Image ID="Image1" runat="server" Height="57px" Width="120px" />
                </td>
            </tr>
              ...
              <tr>
                ...
                <td style="color: #880000">                  
                    ...
                    &nbsp;上传请使用英文名称<br />
                    <asp:Image ID="Image2" runat="server" Height="51px" Width="107px" />
                </td>
            </tr>
            <tr>
                <td align="right" valign="top">
