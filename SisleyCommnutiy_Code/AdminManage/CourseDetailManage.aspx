<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseDetailManage.aspx.cs" Inherits="AdminManage_CourseDetailManage" %>
...
<body>
  ...
  <TR height=28>
    <TD background=images/title_bg1.jpg>当前位置:查看课件详细</TD></TR>
  <TR>
        ...
        <ItemTemplate>
         <tr id="trIdrep" runat="server" onMouseOver="this.bgColor='#C4DFF7'" onMouseOut="this.bgColor='#ffffff'">
                <td nowrap><%#Container.ItemIndex+1%> </td>   
                             ...
                             <td nowrap><%#Eval("MediaCategory")%></td>     
               
                <td nowrap><img src="../upload/CourseMain/<%#Eval("MediaFilePath")%>" width="100px" height="40px;" /></td>  
                <td nowrap><%#Eval("SortNumbers")%></td> 
