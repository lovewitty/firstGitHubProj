...
<table height="100%" cellspacing="0" cellpadding="0" width="170" background="images/menu_bg.jpg"
  ...
  <!-- 5 Begin-->    
   ...
   <!-- 51 Begin-->    
      <table cellspacing="0" cellpadding="0" width="150" border="0">
        <tr height="22">
          <td style="padding-left: 30px" background="images/menu_bt.jpg"><a class="menuParent" onClick="expand(51)" href="javascript:void(0);">Flash广告页</a></td>
        </tr>

      </table>
      <table id="child51" style="display: none" cellspacing="0" cellpadding="0" width="150"
                    border="0">
        <tr height="20">
          <td align="middle" width="30"><img height="9" src="images/menu_icon.gif" width="9"></td>
          <td><a class="menuChild" href="xwFlashItemEdit.aspx" target="main">添加记录</a></td>
        </tr>
        <tr height="20">
          <td align="middle" width="30"><img height="9" src="images/menu_icon.gif" width="9"></td>
          <td><a class="menuChild" href="xwFlashItemManage.aspx" target="main">查看记录</a></td>
        </tr>   
   ...
   <!-- 17 End -->
      ...
      <table cellspacing="0" cellpadding="0" width="150" border="0">
        <tr height="22">
          <td style="padding-left: 30px" background="images/menu_bt.jpg"><a class="menuParent" onClick="expand(18)" href="javascript:void(0);">系统问答管理</a></td>
        </tr>

      </table>
      <table id="child18" style="display: none" cellspacing="0" cellpadding="0" width="150"
                    border="0">
                     <tr height="20">
          <td align="middle" width="30"><img height="9" src="images/menu_icon.gif" width="9"></td>
          <td><a class="menuChild" href="QATypeAdd.aspx" target="main">新增问题类别</a></td>
        </tr>
        <tr height="20">
          <td align="middle" width="30"><img height="9" src="images/menu_icon.gif" width="9"></td>
          <td><a class="menuChild" href="QATypeManage.aspx" target="main">查看类别管理</a></td>
        </tr>              
               
        <tr height="20">
          <td align="middle" width="30"><img height="9" src="images/menu_icon.gif" width="9"></td>
          <td><a class="menuChild" href="sisleyQA_Edit.aspx" target="main">新增Sisley问题</a></td>
        </tr>
        <tr height="20">
          <td align="middle" width="30"><img height="9" src="images/menu_icon.gif" width="9"></td>
          <td><a class="menuChild" href="sisleyQA_Manage.aspx" target="main">查看Sisley问答</a></td>
        </tr>               
      </table>
   <!-- 18 End -->
      <!--2 7 Begin-->    
   ...
   <!-- 17 End -->
    <!-- 27 Begin-->    
      <table cellspacing="0" cellpadding="0" width="150" border="0">
        <tr height="22">
          <td style="padding-left: 30px" background="images/menu_bt.jpg"><a class="menuParent" onClick="expand(270)" href="javascript:void(0);">贴身达人Q&A</a></td>
        </tr>

      </table>
      <table id="child270" style="display: none" cellspacing="0" cellpadding="0" width="150"
                    border="0">                  
        <tr height="20">
          <td align="middle" width="30"><img height="9" src="images/menu_icon.gif" width="9"></td>
        ...
        <tr height="20">
          ...
          <td><a class="menuChild" href="SmartPerson_QA_TypeManage.aspx" target="main">查看提问类别</a></td>
                ...
                <tr height="20">
          <td align="middle" width="30"><img height="9" src="images/menu_icon.gif" width="9"></td>
          <td><a class="menuChild" href="SevicerAdd.aspx" target="main">添加贴身达人</a></td>
        </tr>   
                <tr height="20">
          <td align="middle" width="30"><img height="9" src="images/menu_icon.gif" width="9"></td>
          <td><a class="menuChild" href="SevicerManage.aspx" target="main">贴身达人管理</a></td>
        </tr>   
