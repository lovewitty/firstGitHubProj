<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QATypeEdit.aspx.cs" Inherits="AdminManage_QATypeEdit" %>
    ...
    <table cellspacing="0" cellpadding="2" width="95%" align="center" border="0" style="line-height: 25px;">
        ...
        <tr>
            ...
            <td style="color: #880000">
                ...
                &nbsp;<asp:Button ID="Button3" runat="server" Text="删除所选类别[子类]" OnClick="Button3_Click" />
            </td>
        </tr>
        <tr>
            <td align="right">
