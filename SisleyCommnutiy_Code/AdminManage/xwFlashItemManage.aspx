<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xwFlashItemManage.aspx.cs" Inherits="AdminManage_xwFlashItemManage" %>
...
<body>
  ...
  <TR height=28>
    <TD background=images/title_bg1.jpg>当前位置:查看Flash广告</TD></TR>
  <TR>
        ...
        <ItemTemplate>
         <tr id="trIdrep" runat="server" onMouseOver="this.bgColor='#C4DFF7'" onMouseOut="this.bgColor='#ffffff'">
                <td nowrap><%#Container.ItemIndex+1%> </td>   
                 <td nowrap><%#Eval("aTitle")%></td>              			 					
                 <td nowrap><img src="../upload/Advertisement/<%#Eval("aImg")%>" width="50px" height="30px" /></td>

                <td nowrap><a href='<%#Eval("aLink")%>' target="_blank">查看</a></td>
               
                   <td nowrap><%#Eval("aOrderNumb")%></td>
                    <td nowrap><%#Eval("aTypeName")%></td>
                <td nowrap><%#Eval("aCreatedate")%></td>
                   <td nowrap>
