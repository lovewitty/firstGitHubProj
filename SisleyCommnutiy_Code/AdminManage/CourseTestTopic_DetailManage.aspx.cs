...
public partial class AdminManage_CourseTestTopic_DetailManage : System.Web.UI.Page
{
 ...
 public string recordCount = "";
    ...
    {
        System.Data.DataSet ds = DBEntity.Tab_CourseTest_Question.GetDs_Where(beginDate, endDate, keywords);
    ...
    protected void DataList1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Response.Redirect(string.Format("CourseTestTopic_DetailAddnew.aspx?Idx={0}", btnEdit.CommandArgument.ToString()));
        }

        if (e.CommandName == "deleteDeal")
        {
            new DBEntity.Tab_CourseTest_Question().Delete(btnDelete.CommandArgument.ToString());
        }
