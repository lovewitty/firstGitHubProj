...
public partial class share_detail_02 : System.Web.UI.Page
{
    ...
    private void GetArticleDetail()
    {
        ...
        if (ds.Tables[0].Rows.Count == 1)
        {
            ...
            string strPingFen = iRow["pingFenTotal"].ToString();
            if (string.IsNullOrEmpty(iRow["pingFenTotal"].ToString()))
            {
                strPingFen = "总分|5";
            }

            int pingFenTotal = Convert.ToInt32(strPingFen.Split('|')[1]);
