<%@ Page Language="C#" AutoEventWireup="true" CodeFile="famous_prod-temp4.aspx.cs" Inherits="famous_prod_temp4" %>
...
<div class="wrap">
    ...
    <div class="content">
        ...
        <div class="famousProd">
        	<div class="prod" style="background:url('images/famous_prod-temp4.jpg') no-repeat;border:1px solid #DFDFDF;">
            	<div class="info">
                	<div class="tab">
                    	<ul>
