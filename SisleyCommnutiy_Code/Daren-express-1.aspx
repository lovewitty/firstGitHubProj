<%@ Page Language="C#"  ValidateRequest="false" AutoEventWireup="true" CodeFile="Daren-express-1.aspx.cs"
    Inherits="Daren_express_1" %>
                        ...
                        <div class="details">
                            <div class="condition">
                                <dl class="clear">
                                    <dt>分类</dt>
                                    <dd>
                                        <a href="Daren-express-1.aspx" class="curr">达人测评</a> <a href="Daren-express-2.aspx">
                                ...
                                <dl class="clear">
                                    <dt>产品</dt>
                                    <dd>
                                        <asp:Literal ID="ltl_ProductTypes" runat="server">
                                    <a href="#" class="curr">护肤</a>
                                    <a href="#">彩妆</a>
                                    <a href="#">香水</a>
                                        </asp:Literal>
                                    </dd>
                                ...
                                <dl class="clear">
                                    <dt></dt>
                                    <dd>
                                       <asp:Literal ID="ltl_ProductItems" runat="server">
                                        <a href="#" class="curr">舒润柔肤护手霜</a>
                                        <a href="#">夜幽情怀润体乳</a>
                                        <a href="#">夜幽情怀沐浴啫喱</a>
                                        <a href="#">绿野芳踪沐浴凝胶</a>
                                        <a href="#">绿野芳踪身体乳</a>
                                ...
                                <dl class="selected clear">
                                    <dt>您已选择：</dt>
                                    <dd>
                                        <asp:Literal ID="ltlSelectMark" runat="server">
                                        <a href="#">玫瑰玫瑰我爱你<b>删除</b></a>
                                        <a href="#">社区上线送祝福<b>删除</b></a>
                                        </asp:Literal>
                                    </dd>
                                </dl>
                                <dl class="score clear">
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        <img class="c1" src="images/star_c.jpg" onclick="setPingFen(this,3)" />
                                        <img class="c1" src="images/star_s.jpg" onclick="setPingFen(this,4)" />
                                        <img class="c1" src="images/star_s.jpg" onclick="setPingFen(this,5)" />
                                        <asp:TextBox ID="txtPingFenTotal" runat="server" Visible="false" ></asp:TextBox>
