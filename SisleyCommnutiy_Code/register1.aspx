...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        for (var i = 0; i < arr.length - 1; i++) {
            //var arrTemp = arr[i];
            ddl.append($("<option title=" + arr[i] + " value=" + arr[i] + " >" + arr[i] + "</option>"));
        }
    });
...
//            {
//                type: "POST",
//                url: "dealData/HandlerShareWeibo.aspx",
//                data: String.format("rep=adduserno&btnName={0}", btnName),
...
<div class="wrap">
    ...
    <div class="content">
    	<div class="crumbs">
   	当前位置：<a href="index.aspx">首页</a> <img src="images/arrow_01.gif" align="absmiddle" alt="" /> <a href="register.aspx">用户注册</a> <img src="images/arrow_01.gif" align="absmiddle" alt="" /> <a href="register1.html">会员注册</a></div>
    	<div class="register">
        	<div class="flower_pic"><img src="images/flower_pic.jpg" alt="玫瑰焕采紧致面膜" /></div>
        <div class="reg_content">
            <div><img src="images/title_reg1.jpg" alt="" /></div>
            <ul>
               	<li><label><span>*</span> 会员卡号：</label> <input id="VipCardNo" runat="server" name="" type="text" class="input_reg1" /></li>
               	...
               	<li><label><span>*</span> 姓名：</label> <input id="RealName" runat="server" name="" type="text" class="input_reg1" /></li>
               	<li><label><span>*</span> 手机号码：</label> <input id="MobilePhone" runat="server" name="" type="text" class="input_reg1" /></li>
               	<li><label><span>*</span> 所在省份：</label> <select id="Province" runat="server" name="">
               	  <option selected="selected" value="">--请选择省份--</option>
           	    </select></li>
               	<li><label><span>*</span> 所在城市：</label> <input id="City" runat="server" name="" type="text" class="input_reg2" /> 市</li>
