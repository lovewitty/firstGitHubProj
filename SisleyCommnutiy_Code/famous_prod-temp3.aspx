<%@ Page Language="C#" AutoEventWireup="true" CodeFile="famous_prod-temp3.aspx.cs" Inherits="famous_prod_temp3" %>
...
<div class="wrap">
    ...
    <div class="content">
        ...
        <div class="famousProd">
        	<div class="prod" style="background:url('images/famous_prod-temp3.jpg') no-repeat;border:1px solid #DFDFDF;">
            	<div class="info">
                	<div class="tab">
                    	<ul>
