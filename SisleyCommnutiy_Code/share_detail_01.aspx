<%@ Page Language="C#" AutoEventWireup="true" CodeFile="share_detail_01.aspx.cs" Inherits="share_detail_01" %>
...
<div class="wrap">
    ...
    <div class="content" style="padding-top:7px;">
        <div class="crumbs">
   	当前位置：<a href="index.aspx">首页</a> <img src="images/arrow_01.gif" align="absmiddle" alt="" /> <a href="KOL-share.aspx">达人分享</a> <img src="images/arrow_01.gif" align="absmiddle" alt="" /> <a href="KOL-share.aspx">查看详细</a></div>
  		<div class="KOLshare">
   	    <div class="KOLshare_l">
            ...
            <div class="btn_publ"><a href="Daren-express-2.aspx"><img src="images/btn_publish.jpg" alt="发表分享" /></a></div>
        	<div class="box_c">
...
<span style="color:#a96397; font-size:12px;">人气：235 剩余：20</span></p>
                ...
                <div class="more1"><a href="trial_zone.aspx">查看更多&gt;&gt;</a></div>
            </div>
   	    </div>
        	<div class="KOLshare_r">
        	  	<div class="cosmplan">
                	<div class="cosmplan_title">
                        <asp:Literal ID="ltlTitle" runat="server">像法国女人那样懂送礼</asp:Literal></div>
                    <div class="share_content"> <asp:Literal ID="ltlContent" runat="server"></asp:Literal>
                    </div>
                    <!-- 回复按钮 ,以及回复记录 Begin-->
