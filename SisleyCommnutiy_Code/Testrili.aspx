<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Testrili.aspx.cs" Inherits="Testrili" %>
...
<script type="text/javascript">
    ...
    //添加试用产品 的人气指数
    function Add_TryProductLog(vIdx) {
        var vIdx = "11";
        $.post("data2flash/myAjaxDeal.aspx", { rep: "addTryProductLog", TryProductIdx_Fx: vIdx },
              function (data) {
...
<div class="wrap">
    ...
    <div class="content" style="padding-top:7px;">
        <div class="crumbs">
   	当前位置：<a href="#" onclick="Add_TryProductLog()">首页</a> <img src="images/arrow_01.gif" align="absmiddle" alt="" /> <a href="KOL-share.aspx">达人分享</a> <img src="images/arrow_01.gif" align="absmiddle" alt="" /> <a href="#" onclick="">查看详细</a></div>
  		<div class="KOLshare">
   	    <div class="KOLshare_l">
        	<div class="box_c">
            	<div class="title_pic"><img src="images/title_calendar.jpg" alt="calendar" /></div>
                      ...
                      <div class="">
                          <asp:Calendar ID="Calendar1" runat="server" CssClass="calendarNew" ShowNextPrevMonth="False" 
                              ShowTitle="False" 
